    ...
    extend: {
      ...
      colors: {
        ...
        luxury: {
          ...
          "midnight-dark": "hsl(var(--luxury-midnight-dark))",
          "midnight-light": "hsl(var(--luxury-midnight-light))",
          champagne: "hsl(var(--luxury-champagne))",
          "champagne-light": "hsl(var(--luxury-champagne-light))",
          "champagne-dark": "hsl(var(--luxury-champagne-dark))",
          offwhite: "hsl(var(--luxury-offwhite))",
          bone: "hsl(var(--luxury-bone))",
          dark: "hsl(var(--luxury-dark))",
          charcoal: "hsl(var(--luxury-charcoal))",
          obsidian: "hsl(var(--luxury-obsidian))",
          stone: "hsl(var(--luxury-stone))",
          silk: "hsl(var(--luxury-silk))",
          "bg-main": "hsl(var(--luxury-bg-main))",
        },
      },
      spacing: {
        "18": "4.5rem",
